...
<div class="container" id="content">
    ...
    <div class="card-queue">
        <div class="body">
            <form class="form-horizontal" action="{{url("/management/station/store")}}" method="post">
                {{ csrf_field() }}
                {{ method_field($method) }}
                <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2 control-label">Name (TH)</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="name-th" name="name_th" placeholder="Name TH" >
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2 control-label">Name (EN)</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="name-en" name="name_en" placeholder="Name EN" >
                    </div>
                </div>
                <div class="form-group">
