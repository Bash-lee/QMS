            ...
            <div class="card-queue">
                <div class="body">
                    <div class="avatar" align="center">
                        <img src="https://image.flaticon.com/icons/png/512/146/146022.png" class="img-responsive" alt="Clinical">
                    </div>
                    <div class="text">
                        <hr>
                        <div class="card-text">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-5 center">
                            <div class="text">
                                ...
                                <div class="card-text">
                                    <span class="glyphicon glyphicon-pushpin"></span> {{ $visit->reser == 1 ? 'Book in advance' : 'no advance booking'}}</div>
                                <div class="card-text">
