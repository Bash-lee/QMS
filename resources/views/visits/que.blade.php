...
<div class="container" id="content">
        ...
        <div class="row">
            <div class="col-xs-6">
                <div class="input-group input-group-lg">
                    <span class="input-group-addon pointer" onclick="location.href='{{url('/management/visit/create')}}'">
                        Create Visit
                    </span>
    ...
    <div class="card-queue" data-vid="{{$visit->visit_id}}" data-card_id="{{$visit->patient->card_id}}" data-uid="{{$visit->user_id}}">
            <div class="body">
                <div class="row">

                    <div class="col-xs-5 left">

                      {{ $visit->patient->created_at ->format('h:i')}}
...
<script>
    ...
    function checkout() {
        ...
        if(item.length) {
            bootbox.confirm({
                message: `you sure confirm checkout visit card_id ${item.data('card_id')} ?`,
                buttons: {
                    confirm: {
                        label: 'Checkout',
